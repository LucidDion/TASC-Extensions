...
{
    public class TrendQ : IndicatorBase
    {
        ...
        public TrendQ(TimeSeries source, Int32 period1, Int32 period2, Int32 m, Int32 n, Int32 c, bool UseRMSNoise)
            : base()
        {
        ...
        public override string Name => "TrendQ";

        public override string Abbreviation => "TrendQ";

        public override string HelpDescription => "Trend Quality (Q-Indicator) from the April 2004 issue of Stocks & Commodities magazine.";

        public override string PaneTag => @"TrendQ";
